...
- **Options**, such as vsync and maximum FPS, automatically built ui to change them, easily expandable
- **Controls**, that allow to change keybinds, automatically built ui to change them, easily expandable
- **AABB2D class**
...
3. Start modifying what you wish and build using dotnet (use at least dotnet 6, but dotnet 8 is recommended)
...
## License
This sofware is under the [Unlicense](./LICENSE)